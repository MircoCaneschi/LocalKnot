from PySide6.QtWidgets import QVBoxLayout, QFormLayout, QHBoxLayout, QGridLayout, QLabel, QPushButton, QSizePolicy, \
    QSpacerItem, QComboBox, QLineEdit
...
class BoardsGui:
    ...
    def setup_hidden_layout(self):
        ...
        self.hidden_main_layout.setContentsMargins(0, 0, 0, 0)
        ...
        hidden_data_layout.setContentsMargins(5, 0, 5, 5)
