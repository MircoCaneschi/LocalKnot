...
class KnotsGui:
    ...
    def _setup_main_layout(self):
        ...
        self.knot_no_combo.InsertPolicy(QComboBox.InsertPolicy.InsertAlphabetically)
        bottom_layout.addWidget(self.knot_no_combo,1)

        # top layout
        self.knot_no = self.knot_no_combo.count()
        # shifts
    ...
    def setup_hidden_layout(self):
        ...
        self.hidden_knot_no_combo.InsertPolicy(QComboBox.InsertPolicy.InsertAlphabetically)
        hidden_bottom_layout.addWidget(self.hidden_knot_no_combo)

        # top layout
        self.knot_no = self.hidden_knot_no_combo.count()
        # shifts
        ...
        pith_y.addRow("Length Y", self.hidden_pith_y_line)
